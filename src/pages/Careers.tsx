          ...
          <div className="container mx-auto">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                >
                  We welcome both full-time professionals and interns who are
                  eager to contribute to groundbreaking technology.
                </motion.p>
                    ...
                    {[
                      {
                        title: "Innovation",
                        description:
                          "Work on cutting-edge technology that's changing multiple industries.",
                      },
                      {
                        title: "Impact",
                        description:
                          "Create solutions that enhance safety, performance, and quality of life.",
                      },
                      {
                        title: "Growth",
                        description:
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm mt-12">
                    ...
                    <div className="bg-white rounded-xl p-6 border border-gray-200">
                      <div className="flex flex-col items-center text-center">
                        <img
                          src="/dezi-uploads/a9bb9110-964a-43b0-a5ab-7162140cd133.png"
                          alt="Love Anderberg"
