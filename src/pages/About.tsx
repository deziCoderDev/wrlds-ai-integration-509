        ...
        <div className="container mx-auto">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              >
                We're a team of innovators dedicated to revolutionizing smart
                textile technology for industries worldwide.
              </motion.p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                ...
                >
                  ...
                  <p className="text-gray-600">
                    At WRLDS Technologies, we're on a mission to transform
                    ordinary textiles into intelligent, data-driven solutions
                    that improve safety, performance, and quality of life across
                    industries.
                  </p>
                  <p className="text-gray-600">
                    We believe that by embedding intelligence into everyday
                    fabrics, we can create a more connected, responsive, and
                    safer world.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Innovation:</strong> We push boundaries to
                        create solutions that weren't possible before.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-gray-700 mt-1 mr-3 flex-shrink-0" />
                      <span>
                        <strong>Quality:</strong> We're committed to excellence
                        in every sensor, algorithm, and solution we deliver.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-gray-700 mt-1 mr-3 flex-shrink-0" />
              ...
              >
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm">
                  <p className="text-gray-600 mb-4">
                    ...
                    analog brands. After successfully raising millions of
                    dollars for development, we spent the first two years in
                    full code mode.
                  </p>
                  <p className="text-gray-600 mb-4">
                  ...
                  {[
                    {
                      ...
                      image:
                        "/dezi-uploads/aa5291bd-2417-4c1e-9a02-0bcc71a92507.png",
                    },
                    {
                      name: "Niek Bijman",
                      role: "Software Lead",
                      ...
                      image:
                        "/dezi-uploads/e502f601-c519-43a8-86f5-5fa89ae50d2f.png",
                    },
                    {
                      name: "Chengjie Li",
                      role: "Hardware Lead",
                      ...
                      image:
                        "/dezi-uploads/3de85ddd-15e1-4216-9697-f91abb9a47ce.png",
                    },
                    {
                      name: "Love",
                      role: "COO",
                      ...
                      image:
                        "/dezi-uploads/a9bb9110-964a-43b0-a5ab-7162140cd133.png",
                    },
                  ].map((member, i) => (
                    <Card
                      key={i}
