...
const Blog = () => {
  ...
  const featuredPost =
    blogPosts.find((post) => post.id === "6") || blogPosts[0];
    ...
    <PageLayout>
      <SEO
        ...
        imageUrl={
          ...
          "/dezi-uploads/6b0637e9-4a7b-40d0-b219-c8b7f879f93e.png"
        }
        keywords={[
          "smart textiles",
          "textile technology",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {otherPosts.map((post) => (
            <BlogPostCard
              ...
              imageUrl={
                post.imageUrl ||
                "/dezi-uploads/48ecf6e2-5a98-4a9d-af6f-ae2265cd4098.png"
              }
              date={post.date}
              slug={post.slug}
          ...
          {blogPosts.length < 4 &&
            Array.from({ length: Math.max(0, 4 - blogPosts.length) }).map(
              (_, index) => (
                <BlogPostCard
                  ...
                  imageUrl={
                    index % 2 === 0
                      ? "/dezi-uploads/6b0637e9-4a7b-40d0-b219-c8b7f879f93e.png"
                      : "/dezi-uploads/700e27d7-0513-4bfa-8ac4-f7fd6087594c.png"
                  }
                  date="Coming soon"
                  slug="#"
                  category="Upcoming"
