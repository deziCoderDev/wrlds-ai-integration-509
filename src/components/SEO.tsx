...
const SEO: React.FC<SEOProps> = ({
  ...
  const organizationStructuredData = {
    ...
    name: "WRLDS Technologies",
    url: "https://wrlds.com",
    logo: "https://wrlds.com/dezi-uploads/14ea3fe0-19d6-425c-b95b-4117bc41f3ca.png",
    ...
    isBlogPost && publishDate
      ? {
          ...
          publisher: {
            ...
            logo: {
              "@type": "ImageObject",
              url: "https://wrlds.com/dezi-uploads/14ea3fe0-19d6-425c-b95b-4117bc41f3ca.png",
              width: 512,
              height: 512,
            },
            url: "https://wrlds.com",
  ...
  return (
    <Helmet>
      ...
      {isBlogPost && (
        <meta property="article:publisher" content="https://wrlds.com" />
      )}
