      ...
      <div className="banner-container bg-black relative overflow-hidden h-[50vh] sm:h-[60vh] md:h-[500px] lg:h-[550px] xl:h-[600px] w-full">
        <div className="absolute inset-0 bg-black w-full">
          <video
            ...
            poster="/dezi-uploads/4bfa0d71-3ed2-4693-90b6-35142468907f.png"
          >
            <source
              src="/dezi-uploads/video_1751292840840_1751292842546.mp4"
              type="video/mp4"
            />
            {/* Fallback image if video fails to load */}
            <img
              src="/dezi-uploads/4bfa0d71-3ed2-4693-90b6-35142468907f.png"
        ...
        <div className="banner-overlay bg-transparent pt-20 sm:pt-24 md:pt-32 w-full">
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            ...
            >
              ...
              <motion.p
                className="banner-subtitle text-gray-300 mt-4 sm:mt-6"
                variants={itemVariants}
              >
                We integrate AI-powered textile sensors into clothing, footwear,
                and wearables.
              </motion.p>
              <motion.div
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 text-xs md:text-sm">
              Intelligent fabric sensors that seamlessly integrate into clothing
              and footwear.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 text-xs md:text-sm">
              Industry-specific algorithms that transform textile sensor data
          ...
          >
            ...
            <p className="text-gray-600 text-xs md:text-sm">
              Solutions for sports, military, healthcare, industrial, and
