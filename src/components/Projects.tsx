...
const projects = [
  ...
  },
  {
    ...
    description:
      "Smart Footwear R&D aiming to revolutionize development, fitting, and testing of athletic footwear.",
  ...
  },
  {
    ...
    description:
      "Fully integrated temperature controls for professionals working in extreme heat and cold. Modular approach to enable full-body systems.",
    tags: [
      "Climate Control",
      "Workwear",
  ...
  },
  {
    ...
    brand: "Mars Blades",
    description:
      "R&D product evaluating data from single IMU embedded in the hockey shoe. Aim: establish motion patterns that lead to ultimate acceleration, speed, and maneuverability.",
  ...
  },
  {
    ...
    description:
      "R&D project embedding a step counter in a dog collar. Measures daily activity and sends real-time data to the cloud for veterinary consultancies.",
...
const Projects = () => {
  ...
  return (
    <section
      id="projects"
      ref={projectsRef}
      className="bg-white py-[50px] w-full"
    >
      <div className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600">
            Explore how our textile sensor technology is revolutionizing
            multiple industries with intelligent fabric solutions tailored to
            specific needs.
          </p>
          {isMobile && (
