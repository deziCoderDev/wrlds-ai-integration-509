...
const Features = () => {
  ...
  const features = [
    {
      ...
      description:
        "Specialized fabrics that analyze form, provide instant feedback, and help prevent injuries in athletic equipment.",
      image: "/dezi-uploads/48e540e5-6a25-44e4-b3f7-80f3bfc2777a.png",
    },
    {
      icon: (
        <Shield className="w-10 h-10 text-white transition-transform duration-300 transform" />
      ),
      title: "Military & Defense",
      description:
        "Tactical gear with embedded sensors for soldier health monitoring, environmental awareness, and enhanced safety.",
      image: "/dezi-uploads/48ecf6e2-5a98-4a9d-af6f-ae2265cd4098.png",
    },
    {
      icon: (
        <HardHat className="w-10 h-10 text-white transition-transform duration-300 transform" />
      ),
      title: "Industrial Safety",
      description:
        "Protective workwear that detects hazards, monitors fatigue, and prevents workplace injuries through early intervention.",
      image: "/dezi-uploads/cf8966e3-de0d-445f-9fbd-ee6c48daa7ff.png",
    },
    {
      icon: (
        <Zap className="w-10 h-10 text-white transition-transform duration-300 transform" />
      ),
      title: "Thermal Regulation",
      description:
        "Adaptive heating and cooling textiles that respond to body temperature and environmental conditions.",
      image: "/dezi-uploads/6739bd63-bf19-4abd-bb23-0b613bbf7ac8.png",
    },
  ];
  ...
  const sensorCaseStudies = [
    {
      image: "/dezi-uploads/843446fe-638e-4efb-b885-ed3cd505325a.png",
      title: "Firefighter Safety",
      description:
        "Advanced protective gear with gas, temperature, positioning, and motion sensors for safer emergency response.",
    },
    {
      image: "/dezi-uploads/5463c9c5-0946-4280-a14b-17636ff69a98.png",
      title: "Industrial Worker Protection",
      description:
        "Safety workwear with vibration, pressure, and heating sensors to prevent injuries and monitor environmental hazards.",
    },
    {
      image: "/dezi-uploads/c5f8ee24-9815-4ebe-b65d-6f3d449feb8b.png",
      title: "Sports Performance",
      description:
        "Smart athletic wear with temperature and pressure sensors that track hydration, foot strike patterns, and performance metrics.",
    },
  ];
  const stepFlowItems = [
    {
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8" ref={featuresRef}>
          <div className="text-center mb-10 max-w-3xl mx-auto feature-item">
            ...
            <p className="text-gray-600 mt-4">
              Our textile sensor technology transforms ordinary fabrics into
              intelligent interfaces that collect data, monitor conditions, and
              enhance performance across diverse sectors.
            </p>
          </div>
          ...
          <div className="mt-16 mb-8 feature-item">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
                Explore how our textile sensors are applied in different
                professional contexts, from emergency response to construction
                and athletics.
            ...
            <div className="rounded-xl overflow-hidden bg-white p-4 feature-item">
              ...
              <div className="text-center mt-6 text-sm text-gray-600">
                <p className="font-medium">
                  These examples showcase just a few ways our textile sensors
